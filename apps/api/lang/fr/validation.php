...
return [
    ...
    | comme les règles de taille. N’hésitez pas à ajuster ces messages selon
    ...
    */
    ...
    | des attributs spécifiques en utilisant la convention
    | "attribute.rule". Cela permet de définir rapidement un message précis.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes servent à remplacer le nom de l’attribut dans les
    | messages par quelque chose de plus lisible, comme “Adresse e-mail”
