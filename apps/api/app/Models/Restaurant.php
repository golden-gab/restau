...
#[ApiProperty(serialize: new Groups(['restaurant:read', 'restaurant:write',]), property: 'latitude')]
#[ApiProperty(serialize: new Groups(['restaurant:read', 'restaurant:write',]), property: 'longitude')]
